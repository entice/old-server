...
package object protocol {
  ...
  case class Animation(id: CharacterAnimation = CharacterAnimation.None) extends NetworkAttribute
  ...
  case class Movement(
      ...
      state: MoveState = NotMoving) extends NetworkAttribute
  ...
  implicit val format: Format[NetworkAttribute] = Variants.format[NetworkAttribute]("type")
